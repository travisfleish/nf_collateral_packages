              ...
              {footer.social.map((social) => (
                <li key={social.label}>
                  <a
                    ...
                    className="inline-flex h-8 w-8 items-center justify-center rounded-sm bg-white/10 text-white transition-colors duration-300 ease-in-out hover:bg-white hover:text-pdfSurface"
                  >
