...
export function ContactCtaSection() {
  return (
    <section className="relative overflow-hidden bg-pdfSurface pb-12 pt-2 text-white md:pb-16 md:pt-3">
      <div
        aria-hidden="true"
        ...
        <div className="grid items-center gap-8 lg:grid-cols-[1fr_minmax(360px,500px)] lg:gap-10">
            ...
            <dl className="mt-16 hidden w-full gap-4 sm:grid-cols-3 sm:gap-5 md:mt-16 md:grid">
              {contactCtaStats.map((stat) => (
                <div key={stat.id} className="flex flex-col items-center">
                  ...
                  <dd className="mt-2 max-w-[14ch] text-center text-sm leading-snug text-white/75 md:text-base">
                    {stat.label}
                  </dd>
                </div>
              ))}
          ...
          <div className="mx-auto w-full max-w-[46rem] overflow-hidden rounded-2xl bg-white p-4 shadow-[0_20px_45px_rgba(0,0,0,0.22)] md:p-6 lg:mx-0 lg:max-w-none">
            <iframe
              ...
              className="h-[980px] w-full sm:h-[900px] md:h-[560px] lg:h-[640px] xl:h-[620px] 2xl:h-[620px]"
              width="100%"
              height="980"
              frameBorder="0"
